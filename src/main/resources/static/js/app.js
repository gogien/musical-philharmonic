                ...
                <section class="features">
                    <div class="shell">
                        ...
                        <div class="about-info-card">
                            <p>
                                Филармония <strong>52harmonic</strong> — это уникальное культурное пространство, где традиции академической музыки переплетаются с современными экспериментами. Основанная в <strong>1952 году</strong>, она с самого начала задумывалась как место открытого диалога между разными музыкальными стилями и поколениями слушателей. За десятилетия своего существования 52harmonic стала важным символом музыкальной жизни города и площадкой для смелых творческих идей.
                            </p>

                            <p>
                                Сегодня на сцене филармонии регулярно выступают такие яркие коллективы и исполнители, как <strong>whole lotta swag</strong>, <strong>friendly thug</strong> и <strong>joker james</strong>. Их концерты отличаются узнаваемым звучанием, эмоциональной подачей и постоянным поиском новых форм выражения. Благодаря этому репертуар 52harmonic остается живым и актуальным, привлекая как ценителей классики, так и поклонников современных направлений.
                            </p>

                            <p>
                                52harmonic по праву считается местом, где музыка не просто звучит, а развивается и переосмысливается. Сочетая уважение к своей истории с вниманием к новым именам и жанрам, филармония продолжает выполнять свою главную миссию — вдохновлять слушателей и создавать пространство для подлинного музыкального искусства.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="about-container">
                        ...
                        <div class="about-card">
                            ...
                            <div class="about-info">
                                <p><strong>ФИО:</strong> Гогин Григорий Андреевич</p>
                                <p><strong>Группа/Учебное заведение:</strong> ИД23-3</p>
                                <p><strong>Email:</strong> <a href="mailto:gogingrisha@gmail.com}">gogingrisha@gmail.com</a></p>
                                <p><strong>Телефон:</strong> +7 (916) 583-94-76</p>
                            </div>
                        </div>
                        <div class="about-card">
